            ...
            <div class="app-card-body p-4">
              <nav aria-label="breadcrumb">
                ...
                <div class="row gx-5 gy-3">
                    ...
                    @endcan
                    <div class=" @can("create accounts") col-lg-8 @else col-lg-12 @endif">
                        <div class="row">
                            <div class="col-lg-8">
                                <form>
                            ...
                            <tbody>
                                @forelse ($users as $user)
                                    <tr>
                                        ...
                                        <td class="text-end">
                                            @can("update accounts")
                                                <a href="{{ route('user.edit', $user->id) }}" class="btn-sm app-btn-primary"> <i class="fa fa-pencil"></i></a>
                                            @endcan
                                            @can("delete accounts")
                                                <a href="#" onclick="if(confirm('Are you sure to delete?')){ document.getElementById('delete-{{ $user->id }}').submit() }" class="btn-sm text-white btn-danger"><i class="fa fa-trash"></i></a>
