                ...
                <div class="inner">
                    <div class="app-card-body p-4">
                        <nav aria-label="breadcrumb">
                            ...
                            <form action="{{ route('petty-cash.store') }}" method="POST"  class="overlayed-form">
                                @csrf
                                ...
                                <div class="mb-3">
                                    ...
                                    <select name="personnel_id" class="form-select mb-2 select2" data-uri="/api/personnel/select2">
                                    </select>
                                </div>
                                {{-- <div class="mb-3">
                                ...
                                <div class="mb-3">
                                    ...
                                    <input name="effectivity_date" readonly type="date" max="{{ now()->format("Y-m-d") }}" min="{{ now()->format("Y-m-d") }}" value="{{ now()->format("Y-m-d") }}" class="form-control mb-2" required>
                                </div>
