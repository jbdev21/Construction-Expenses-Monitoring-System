                                    ...
                                    <tr>
                                        ...
                                        <td class="text-end">
                                            @can('update categories')
                                                <a href="{{ route('category.edit', $category->id) }}" class="btn-sm app-btn-primary"> <i class="fa fa-pencil"></i></a>
                                            @endcan
                                            @can('delete categories')
                                                <a href="#" onclick="if(confirm('Are you sure to delete?')){ document.getElementById('delete-{{ $category->id }}').submit() }" class="btn-sm text-white btn-danger"><i class="fa fa-trash"></i></a>
                                                <form id="delete-{{ $category->id }}" action="{{ route('category.destroy', $category->id) }}" method="POST">@csrf @method('DELETE')</form>
                                            @endcan
                                        </td>
                                    </tr>
